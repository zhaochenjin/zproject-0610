...
load data local infile 'D:\\temp\\PycharmProjects\\zproject-0610\\machine_learning_project\\data\\train_July.csv' into table db_ml.train fields terminated by ',' lines terminated by '\r\n' ignore 1 lines;

load data local infile 'D:\\temp\\PycharmProjects\\zproject-0610\\machine_learning_project\\data\\weather.csv'
...
load data local infile 'D:\\temp\\PycharmProjects\\zproject-0610\\machine_learning_project\\data\\poi.csv'
    into table db_ml.poi
    fields terminated by ','
    ignore 1 lines(id, @dummy, petrol, @dummy, market, @dummy, uptown, @dummy, metro, @dummy, bus, @dummy, cafe,
                    @dummy, restaurant,
...
select * from db_ml.train_data order by order_count desc;
